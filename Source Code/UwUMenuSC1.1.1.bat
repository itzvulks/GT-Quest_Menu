...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFCtGSQCDKGSoOpEZ++Pv4Pq7l1ooeecxbd6Vi/rfbuUL7yU=
::YB416Ek+ZG8=
::
::
...
echo.
set /p opt1=Do you have QuestPatcher2.2.2 installed yet? y/n:
echo.
if %opt1% == y goto mods
if %opt1% == n goto questpatcher
:questpatcher
bitsadmin /transfer QuestPatcher /download /priority normal https://github.com/Lauriethefish/QuestPatcher/releases/download/2.2.2/QuestPatcher-windows.exe %filepath%\QuestPatcher-windows.exe
timeout 3 >nul 
...
set /p qpd=Please enter 1 ONLY once QuestPatcher is installed:
if %qpd% == 1 goto mods
:mods
